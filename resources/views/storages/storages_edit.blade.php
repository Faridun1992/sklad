    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Редактирование склада {{$storage->title}}</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div>
                                            ...
                                            <div class="col-auto subheader__breadcrumbs">
                                                <ol id="breadcrumbs" class="breadcrumb page-breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item active"><span
                                                            aria-current="location">Редактирование склада {{$storage->title}}</span>
                                                    </li>
                                                </ol>
                                            </div>
                                        </div>
                    ...
                    <div>
                        <div class="card card-with-table"><!---->
                            <div class="card-header"><span class="card-header-title">Редактирование скалада {{$storage->title}}</span></div>
                            <div class="card-body"><!----><!---->
                                <form action="{{route('storages.update', $storage)}}" method="post"
                                    ...
                                    <div class="form-group has-feedback">
                                        <label for="title">Имя сотрудника</label>
                                    ...
                                    <div class="form-group">
                                        <label>
                                            ...
                                            <input type="checkbox" name="status"
                                                   value="1" {{($storage->status) ? 'checked' : '0'}}>
